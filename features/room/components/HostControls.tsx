...
export function HostControls({ task, round, canReveal, suggestedEstimate, onReveal, onRestart, onCancel, onFinalize }: { task?: PokerTask; round?: Round; canReveal: boolean; suggestedEstimate: VoteValue | null; onReveal: () => void; onRestart: () => void; onCancel: () => void; onFinalize: (estimate: string) => void }) {
